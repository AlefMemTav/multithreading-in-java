...
import multithreading.concurrency.service.StoreServiceWithDiscount02;

public class CompletableFuture06 {

    public static void main(String[] args) {
        StoreServiceWithDiscount02 service = new StoreServiceWithDiscount02();
        searchPricesWithDiscountAsync(service);
    }

    private static void searchPricesWithDiscountAsync(StoreServiceWithDiscount02 service) {
